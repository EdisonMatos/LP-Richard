...
const content = {
  texts: {
    ...
    about: {
      ...
      subtitle:
        "Advogado criminalista com especialização em execução penal, inscrito nos quadros da ordem dos advogados do Brasil do estado de Santa Catarina (OAB/SC 70972)",
      paragraph: (
        <div>
